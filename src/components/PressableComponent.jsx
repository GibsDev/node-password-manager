 ...
 * @param {function} props.component The child component if using single tag format <PressableComponent component={foo} />
 */
const PressableComponent = ({ onPress, onRelease, onClick, children, component }) => {
	...
	if (!children) {
		if (!component) {
			throw new Error(`PressableComponent must specify a 'component' prop if empty`);
		}
